    ...
    return MaterialApp(
      ...
      home: Scaffold(
        body: Container(  
          ...
          child: SafeArea( // agar konten ga ketutupan status bar/notch
            child: SingleChildScrollView(  //biar konten bisa di scroll
              ...
              child: Column(
                ...
                children: [
                  ...
                  // AppBar custom
                  Container(       //dibuat container agar bisa di modif manual sendiri
                  ...
                  Center(
                    child: ClipRRect(      //gambar diposisikan di tengah
                      ...
                      child: Container(
                        ...
                        child: Image.network(
                          ...
                          fit: BoxFit.cover,    // gambar memenuhi ukuran tanpa distorsi
                        ),
                      ),
                    ),
                  ),
                  ...
                  // Lirik mepet kanan
                  Align(
                    alignment: Alignment.centerRight,  //teks harus dipojok kanan layar 
                    child: Text(
                      ...
                      "Janganlah banyak bicara kita jalani saja\n\n"
                      "Na na na nanana na na na nanana",
                      textAlign: TextAlign.right,  //isi teks rata kanan
                      style: TextStyle(
                        fontSize: 20,
                        color: Colors.white,
                        fontFamily: 'Georgia',
                        height: 1.6,   
                        shadows: [  //agar teks bisa dibaca ada shadow nya
                          Shadow(
